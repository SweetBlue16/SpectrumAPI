...
{
    /// <summary>
    /// Defines methods for seeding and cleaning demo data used in development and testing environments.
    /// </summary>
    public interface IDemoSeedService
    {
        /// <summary>
        /// Creates a complete demo dataset after removing any previously generated demo data.
        /// Populates SQL and MongoDB databases with deterministic sample content.
        /// </summary>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Statistics describing the amount of generated demo data.</returns>
        Task<DemoSeedResultDto> SeedAsync(CancellationToken cancellationToken = default);

        /// <summary>
        /// Removes all demo records previously generated by the seed process
        /// from both relational and MongoDB databases.
        /// </summary>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Statistics describing the amount of removed demo data.</returns>
        Task<DemoSeedResultDto> CleanupAsync(CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// Generates and removes demo data used for development and testing environments.
    /// Creates realistic sample users, reviews, clips, reports, comments, votes,
    /// giveaway events, and participants across both relational and MongoDB data stores.
    /// </summary>
    public class DemoSeedService : IDemoSeedService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DemoSeedService"/> class with required dependencies.
        /// </summary>
        /// <param name="context">The database context.</param>
        /// <param name="gameRepository">The game repository.</param>
        /// <param name="options">The demo seed options.</param>
        ...
        /// <summary>
        /// Ensures a valid game catalog exists for demo generation.
        /// Uses repository games when available or generates fallback games otherwise.
        /// </summary>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Collection of games available for demo content generation.</returns>
        ...
        /// <summary>
        /// Builds the demo user set including one administrator
        /// and multiple reviewer accounts with deterministic identities.
        /// </summary>
        /// <param name="now">Reference date used for generated timestamps.</param>
        /// <returns>Collection of demo users.</returns>
        ...
        /// <summary>
        /// Generates demo reviews distributed across users and games,
        /// including ratings, attachments, and engagement metrics.
        /// </summary>
        /// <param name="users">Demo reviewer accounts.</param>
        /// <param name="games">Available demo games.</param>
        /// <param name="now">Reference date used for timestamps.</param>
        /// <returns>Collection of generated reviews.</returns>
        ...
        /// <summary>
        /// Generates demo gameplay clips associated with demo users and games.
        /// </summary>
        /// <param name="users">Demo reviewer accounts.</param>
        /// <param name="games">Available demo games.</param>
        /// <param name="now">Reference date used for timestamps.</param>
        /// <returns>Collection of generated clips.</returns>
        ...
        /// <summary>
        /// Seeds MongoDB collections with comments, votes, reports,
        /// giveaway events, and participant records.
        /// </summary>
        /// <param name="users">Demo users.</param>
        /// <param name="reviews">Demo reviews.</param>
        /// <param name="now">Reference date used for timestamps.</param>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Statistics describing inserted MongoDB records.</returns>
        ...
        /// <summary>
        /// Removes all MongoDB documents associated with demo users and demo-generated content.
        /// </summary>
        /// <param name="demoUserIds">Identifiers of demo users.</param>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Statistics describing deleted MongoDB records.</returns>
        ...
        /// <summary>
        /// Creates demo comment documents associated with generated reviews.
        /// </summary>
        /// <param name="users">Demo users.</param>
        /// <param name="reviews">Demo reviews.</param>
        /// <param name="now">Reference date used for timestamps.</param>
        /// <returns>MongoDB comment documents.</returns>
        ...
        /// <summary>
        /// Creates demo vote documents for generated reviews.
        /// </summary>
        /// <param name="users">Demo users.</param>
        /// <param name="reviews">Demo reviews.</param>
        /// <returns>MongoDB vote documents.</returns>
        ...
        /// <summary>
        /// Creates demo report documents targeting reviews, comments, and users.
        /// Includes both pending and resolved moderation cases.
        /// </summary>
        /// <param name="users">Demo users.</param>
        /// <param name="reviews">Demo reviews.</param>
        /// <param name="comments">Generated comment documents.</param>
        /// <param name="now">Reference date used for timestamps.</param>
        /// <returns>MongoDB report documents.</returns>
        ...
        /// <summary>
        /// Creates demo giveaway event documents representing active,
        /// upcoming, and completed giveaway scenarios.
        /// </summary>
        /// <param name="users">Demo users.</param>
        /// <param name="now">Reference date used for timestamps.</param>
        /// <returns>MongoDB giveaway event documents.</returns>
        ...
        /// <summary>
        /// Creates participant records for generated giveaway events.
        /// </summary>
        /// <param name="users">Demo users.</param>
        /// <param name="events">Generated giveaway events.</param>
        /// <param name="now">Reference date used for timestamps.</param>
        /// <returns>MongoDB participant documents.</returns>
        ...
        /// <summary>
        /// Creates a connection to the Social MongoDB database.
        /// </summary>
        /// <returns>MongoDB database instance for social features.</returns>
        ...
        /// <summary>
        /// Creates a connection to the Drops MongoDB database.
        /// </summary>
        /// <returns>MongoDB database instance for giveaway features.</returns>
        ...
        /// <summary>
        /// Converts a date value into a Unix timestamp expressed in milliseconds.
        /// </summary>
        ...
        /// <summary>
        /// Generates a deterministic GUID from a seed key.
        /// Ensures stable identifiers across repeated seed executions.
        /// </summary>
        /// <param name="key">Unique seed key.</param>
        /// <returns>Deterministic GUID value.</returns>
        ...
        /// <summary>
        /// Creates a fallback game catalog when repository data is unavailable.
        /// </summary>
        /// <returns>Collection of predefined demo games.</returns>
